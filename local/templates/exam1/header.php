    ...
    <header class="header">
        <div class="inner-wrap">
            ...
            <div class="main-phone-block">
                ...
                <?
                $now = new DateTime();
                $workingHoursStart = new DateTime('09:00');
                $workingHoursEnd = new DateTime('18:00');

                if ($now >= $workingHoursStart && $now <= $workingHoursEnd) {
                    $contactInfo = '<a href="tel:84952128506" class="phone">8 (495) 212-85-06</a>';
                } else {
                    $contactInfo = '<a href="mailto:store@store.ru" class="phone">store@store.ru</a>';
                }
                ?>
